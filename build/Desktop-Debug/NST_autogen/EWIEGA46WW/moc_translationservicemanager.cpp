...
template <> constexpr inline auto TranslationServiceManager::qt_create_metaobjectdata<qt_meta_tag_ZN25TranslationServiceManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'handleTranslationFinished'
        QtMocHelpers::SlotData<void(const qtlingo::TranslationResult &)>(7, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
...
void TranslationServiceManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->handleTranslationFinished((*reinterpret_cast< std::add_pointer_t<qtlingo::TranslationResult>>(_a[1]))); break;
        case 3: _t->handleErrorOccurred((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
